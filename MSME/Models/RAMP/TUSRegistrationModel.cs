...
{
    public class TUSRegistrationModel : BaseEntity
    {
        [Key]
        public int? TUSRegistrationId { get; set; }
        ...
        [Display(Name = "Schemes For MSME")]
        [Required(ErrorMessage = "Please Enter Schemes For MSME")]
        public string? SchemesForMSME { get; set; }

        [Display(Name = "GreenTechnologyOpted")]
        [Required(ErrorMessage = "Please Enter Green Technology Opted")]
        public string? GreenTechnologyOpted { get; set; }
        ...
        public List<TUSRegistrationModel> TUSRegistrationList { get; set; } = new List<TUSRegistrationModel>();
    }
}
