    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: { default: "File extension should be .xlsx", replace: "Drag and drop or click to replace", remove: "Remove", error: "Ooops, something wrong appended." },
                error: {
                ...
                tpl: {
                    ...
                    message: '<div class="dropify-message d-flex" style="justify-content: center;"><div><i class="fa fa-cloud-upload"></i></div><div style="text-align:left; padding-left:25px;"><h3 style="margin-bottom:0px;">Upload File</h3> <p>{{ default }}</p></div></div>',
